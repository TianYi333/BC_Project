 ...
 * oled错误消息
 */
extern QueueHandle_t QUEUE_OLED;
/**
 * 配置修改消息
 */
extern QueueHandle_t QUEUE_CONN;
/**
 * 键盘操作消息
 */
 ...
 * 金属接近传感器
 */
extern QueueHandle_t QUEUE_MET_SEN;
/**
 * CAN1其它消息
 */
extern QueueHandle_t msgQueue_ID_CAN1;
/**
 * CAN2其它消息
 */
extern QueueHandle_t msgQueue_ID_CAN2;
