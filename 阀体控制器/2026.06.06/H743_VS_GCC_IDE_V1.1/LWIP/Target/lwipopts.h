...
#define TCP_SND_BUF          (8 * 1024)   // 8KB，根据内存余量可改为 4KB 或 6KB
#define TCP_MSS              1460         // 可选，确保 MSS 明确
#define TCP_WND              (8 * 1024)   // 接收窗口也可适当增大，非必须
/* USER CODE END 0 */
...
#define MEM_SIZE (16 * 1024)//由65535调整到16k
