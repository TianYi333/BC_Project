...
#define MOTOR_RUNNING_FAILURE       0x01//电机运行失败
#define P_MODEL_RESET_FAILURE       0x02//P电机复位失败
#define Q_MODEL_RESET_FAILURE       0x03//q电机复位失败
...
typedef enum motor_status {
	MOTOR_STATUS_READY,//就绪
	MOTOR_STATUS_PROTECTED,//保护
	MOTOR_STATUS_OFFLINE//离线
} _MOTOR_STATUS;
...
typedef enum sensor_status {
	...
	SENSOR_STATUS_T_OFFLINE,//T离线
	SENSOR_STATUS_D_OFFLINE//D离线
} _SENSOR_STATUS;
