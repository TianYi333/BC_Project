...
void ADCTask(void *argument)
{
    ...
    for (;;)
    {
        if(adc_data_ready == 1)
        {
            ...
            // 两点校准修正压力电流
            float press_k = (20.0f - 4.0f) / (sys_cfg.press_cal_20ma_raw - sys_cfg.press_cal_4ma_raw);
            float press_off = 4.0f - press_k * sys_cfg.press_cal_4ma_raw;
            ...
            // 两点校准修正温度电流
            float temp_k = (20.0f - 4.0f) / (sys_cfg.temp_cal_20ma_raw - sys_cfg.temp_cal_4ma_raw);
            float temp_off = 4.0f - temp_k * sys_cfg.temp_cal_4ma_raw;
