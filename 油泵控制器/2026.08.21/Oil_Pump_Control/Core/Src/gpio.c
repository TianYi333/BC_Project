...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LED_2_Pin|DO_OUTPUT_0_Pin|DO_OUTPUT_1_Pin|DO_OUTPUT_2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, RS485_1_RTS_Pin|RS485_2_RTS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DO_OUTPUT_0_Pin DO_OUTPUT_1_Pin DO_OUTPUT_2_Pin */
  GPIO_InitStruct.Pin = DO_OUTPUT_0_Pin|DO_OUTPUT_1_Pin|DO_OUTPUT_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : RS485_1_RTS_Pin RS485_2_RTS_Pin */
  GPIO_InitStruct.Pin = RS485_1_RTS_Pin|RS485_2_RTS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
