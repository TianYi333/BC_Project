...
/*-----------------------------------------------------------------------------*/
/* USER CODE BEGIN 1 */
/* Restored to CubeMX defaults: lwIP pbuf/memp allocations route through
 * newlib malloc to avoid blowing up RAM_D1 with statically-reserved pools.
 * The newlib heap is protected by __malloc_lock/__malloc_unlock in
 * Core/Src/sysmem.c. */
/* USER CODE END 1 */
