...
osThreadId_t ethernet_link_threadHandle;
...
void SW_Reset(void) {
	...
	osDelay(10);
	HAL_GPIO_WritePin(SW_RST_GPIO_Port, SW_RST_Pin, GPIO_PIN_SET);
	osDelay(100);
}
...
/* USER CODE BEGIN H7_OS_THREAD_NEW_CMSIS_RTOS_V2 */
  ...
  ethernet_link_threadHandle = osThreadNew(ethernet_link_thread, &gnetif, &attributes);
