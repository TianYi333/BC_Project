...
osThreadId_t injector_taskHandle;
...
void PrintTaskStackAndCount(void)
{
    ...
    LOG("9 ,injector_task             min stack left: %lu bytes", uxTaskGetStackHighWaterMark(MainLogicTaskHandle));
    LOG("10,Task_InitTask             min stack left: %lu bytes", uxTaskGetStackHighWaterMark(Task_InitTaskHandle));
    ...
    LOG("16,ADCTask                   min stack left: %lu bytes", uxTaskGetStackHighWaterMark(ADCTaskHandle));
