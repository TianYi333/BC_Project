...
SemaphoreHandle_t flash_kv_mutex;
SemaphoreHandle_t udp_pcb_mutex;
SemaphoreHandle_t tcp_send_mutex;
SemaphoreHandle_t sys_status_mutex;
...
void Mutex_Init(void) {
    ...
    flash_kv_mutex   = xSemaphoreCreateRecursiveMutex();
    udp_pcb_mutex    = xSemaphoreCreateRecursiveMutex();
    tcp_send_mutex   = xSemaphoreCreateRecursiveMutex();
}
